...
import { Plus, Trash2, Edit, AlertCircle, CheckCircle2, Loader2, PieChart } from "lucide-react";
      ...
      <main className="flex-1 py-8 px-4 md:px-8">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
            <h1 className="text-3xl font-bold mb-2 md:mb-0 bg-gradient-to-r from-primary to-blue-600 text-transparent bg-clip-text">Budget Planning</h1>
