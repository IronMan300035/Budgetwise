        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-lg">
                BudgetWise began in 2021 when our founder, frustrated with the complexity of existing financial tools, set out to build something better. What started as a simple budgeting app has grown into a comprehensive platform that helps thousands of users track, plan, and grow their finances.
              </p>
            </div>
